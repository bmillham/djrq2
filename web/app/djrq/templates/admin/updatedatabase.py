...
: def updateprogress title, ctx
    ...
    <div class='row'>
        ...
        <div class='col-sm-1 col-lg-1'><img src='/public/icons/horse_7.gif' id='spinner' alt='spinner' style='display: none; top: 25px; width:25px; height: 25px; position: relative' /></div>
    </div>
    <div class='progress'>
